...
//                new XYChart.Data<Number,Number>(day[0],day[1],new CandleStickExtraValues(day[2],day[3],day[4],day[5]))
            		 new XYChart.Data<String,Number>(day[0]+"",day[1],new CandleStickExtraValues(0,day[3],day[4],day[5]))
            );
        }
...
//                        	System.out.println(xa.getDisplayPosition(xa.getTickLabelGap()+""));
                            candleWidth = xa.getDisplayPosition(xa.getTickLabelGap()+"") * 0.90; // use 90% width between ticks
                        }
                        // update candle
